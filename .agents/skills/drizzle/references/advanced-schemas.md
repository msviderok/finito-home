...
> **Outdated for this repo.** Pre–1.0-beta, PostgreSQL-first examples (`pgTable`, object-style `sqliteTable` extras, v1 `relations`). Use [SKILL.md](../SKILL.md), [relations-v2.md](relations-v2.md), and [orm.drizzle.team](https://orm.drizzle.team) for `1.0.0-beta.22`.
